...
class AuthorizeNetAIM_3_1(GenericGateway):
    ...
    api = {
        ...
        'x_trans_id': None,
        'x_split_tender_id': None,
        # The payment gateway-assitned ID assigned when the original transaction includes  two or more partial payments.
    ...
    def populateAPI(self, transaction, api):
        ...
        if transaction.method.__class__ == payment_processor.methods.CreditCard:
            ...
            api[
                'x_bank_acct_name'] = 'CHECKING' if transaction.method.account_type == payment_processor.methods.Check.CHECKING else 'SAVINGS'
